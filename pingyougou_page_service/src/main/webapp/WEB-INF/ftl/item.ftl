		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${itemCat1}<#--手机、数码、通讯--></a>
					</li>
					<li>
						<a href="#">${itemCat2}<#--手机--></a>
					</li>
					<li>
						<a href="#">${itemCat3}<#--Apple苹果--></a>
					</li>
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap">
					<div class="sku-name">
						<h4> {{sku.title}}  <#--Apple iPhone 6s（A1700）64G玫瑰金色 移动通信电信4G手机--></h4>
					</div>
					<div class="news"><span>${goods.caption}  <#--推荐选择下方[移动优惠购],手机套餐齐搞定,不用换号,每月还有花费返--></span></div>
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em>{{sku.price}}<#--${goods.price}--><#--5299.00--></em>
								<span>降价通知</span>
							</div>
							<div class="fr remark">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								<dt>
									<div class="fl title">
									<i>${specification.attributeName}<#--选择颜色--></i>
								</div>
								</dt>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a  target="_blank" ng-click="addToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="tab-main intro">
						...
						<div class="tab-content tab-wraped">
							...
							<div id="two" class="tab-pane">
								<p>${goodsDesc.packageList}<#--规格与包装--></p>
							</div>
							<div id="three" class="tab-pane">
								<p>${goodsDesc.saleService}<#--售后保障--></p>
							</div>
